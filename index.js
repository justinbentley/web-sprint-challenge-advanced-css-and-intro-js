...
for (let i=0; i<artists.length;i++){
  let result = artists[i].years.split(" - ");
  if (result[0] >= "1900" && result[1] <= "2000") {
...
function addArtist(array){
    array.push({ 
      ...
      "bio": "seLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.ntences (or use lorem ipsum"})
